...
# ============================================================
# Usage:
# python3 plot_energy.py N [J1] [J2] [hy] [hz]
# ============================================================
...
plt.title(rf"N={N}, J1={J1/100.0}, J2={J2/100.0}, h_y={hy/100.0}, h_z={hz/100.0}")
plt.grid(True)
plt.tight_layout()
...
plt.savefig(
    os.path.join(plot_dir, f"GroundStateEnergy_{N}_{J1}_{J2}_{hy}_{hz}.png"),
    dpi=300
)
...
plt.xlabel(r"$h_x$")
plt.ylabel(r"$d^2E/dh_x^2$")
plt.title(rf"Second Derivative, N={N}, J1={J1/100.0}, J2={J2/100.0}, h_y={hy/100.0}, h_z={hz/100.0}")
plt.grid(True)
plt.tight_layout()

plt.savefig(
    os.path.join(plot_dir, f"SecondDerivative_{N}_{J1}_{J2}_{hy}_{hz}.png"),
    dpi=300
)
